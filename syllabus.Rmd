...
<br>
The course will use [Python 3](https://www.python.org/)/[R](https://www.r-project.org/) and [Markdown](https://markdown.tw/) for assignments; Prerequisites: Introduction to Semantics.


It is noted that this course is meant to be a (semi-) flipped class with much of the material online. Most of the contents are video-recorded, and you should watch them at home. 
