...
- <span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> Email instructors: shukaihsieh@g.ntu.edu.tw
- Teaching assistants: Chris Schmidt and Chiung-Yu Chiang (Joy)
...
### _Lectures_
- Fridays, 10:00-11:50 in R307, LeXue Building. 

<br>

### _Tutorials_
- Fridays, 12:10-13:00 in R307, LeXue Building. 
...
Each week you will watch a series of short videos, complete a short quiz, submit an assignment. By the end of this course, you should be able to:

- Apply and evaluate computational methods in semantic studies.
...
The course will use [Python 3](https://www.python.org/), [R](https://www.r-project.org/) and [R markdown](https://rmarkdown.rstudio.com/).
...
- Dan Jurafsky and Jim Martin. *Speech and Language Processing*.(3rd).
- Yoav Goldberg. *Neural Network Methods for Natural Language Processing*. 
- Emily Bender. *Linguistic Foundamentals for Natural Language Processing*.
- Muller an Guido. (2017). *Introduction to Machine Learning with Python*. O'REILLY. 
...
R Markdown source for this website <a href="https://github.com/loperntu/comsem/">
